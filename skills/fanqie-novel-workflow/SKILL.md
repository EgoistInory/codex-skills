...
### 关系、亲密与高风险内容专项规范的条件加载

若目标书籍存在关系、亲密内容、内容分级、权力伤害或其他高风险场景专项规范，不把它们设为所有章节的固定上下文；由当前章纲、近期正文、状态文件和审校目标判断是否触发。文件名称、世界观术语和具体边界以目标书籍自己的项目约定为准。

以下内容触发后，必须在动笔、扩写、重写或审校前读取对应专项规范：

- 关系性质或亲密程度发生实质变化，涉及吸引、试探、承诺、身体接触、边界协商或关系确认。
- 存在明显权力不对等、同意受限、操控、胁迫、利用、控制、侵犯或其他非自愿伤害。
- 涉及弱势一方的处境、旁观与介入、救援选择、事后创伤、恢复过程、关系后果或社会与制度后果。

不涉及上述内容的普通行动、探索、成长、日常或制度推进章节，无需重复加载专项规范。触发判断不能只依赖当前会话记忆；项目 `AGENTS.md`、`PROJECT_BRIEF.md`、`HANDOFF.md` 或其他恢复入口若列有条件必读文件，以项目入口为准。
...
2. 对照章纲和设定，列出本章必须推进、禁止提前揭露、禁止改写的内容；同时判断是否触发关系、亲密或高风险内容专项规范，触发时先读取再设计场景。
...
36. 若本章触发关系、亲密或高风险内容专项规范，是否已按项目文件核对适用年龄与内容分级、知情同意、边界与中止权、权力差、伤害表现和关系后果；涉及非自愿伤害时，叙事是否聚焦人物处境、选择、反抗、证据、创伤与后果，避免把伤害过程写成刺激消费。
