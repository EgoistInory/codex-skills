...
以目标项目入口或书籍事实源明确声明的专项约束为定位依据。只有入口文件、书籍简介或交接文件明确指定路径时才加载，不自行按相似文件名或关键词猜测。

不要把这类专项约束设为所有章节的固定上下文。结合当前章纲、近期正文、状态文件、交接记录和本次任务判断是否触发；判断看场景实际功能，不做词语命中式路由。

出现以下任一场景功能时，在动笔、扩写、重写或审校前读取项目入口指定的专项约束：

- 人物关系或亲密程度发生实质变化，场景涉及吸引、试探、承诺、身体接触、边界协商或关系确认。
- 人物意愿受到权力差、依赖关系、操控、威胁、欺骗、限制或其他外部条件影响。
- 场景涉及非自愿伤害、弱势一方处境、旁观与介入、救援选择、事后创伤、恢复过程、关系后果或社会后果。

不承担这些功能的行动、探索、成长、日常或制度推进章节，无需重复加载。触发后，以书内专项约束定义的内容尺度、人物边界、题材术语、呈现重点和审校标准为准；本 Skill 不另行发明或覆盖某本书的具体规则。

若剧情明确触发但指定路径不存在，先检查项目入口是否声明了等价文件；仍无法定位时，将缺失情况记录为待补约束，不自行创建文件或用相似名称猜测，也不得因此中断既定剧情、删除关键关系推进或回避必要的成人内容。应依据现有大纲、人物设定、前文事实、平台尺度和通用创作边界继续写作：正常呈现成年人物的暧昧、亲密与关系变化，也允许通过越界行为及其后果塑造道德底线更低的反派，但不得借约束缺失擅自升级露骨程度、改变人物意愿或偏离既定剧情。专项约束恢复后，再补做一致性复核并按需最小修订。
...
- 不排斥全知视角或提示式旁白。人物多、线索密、场面转换快时，可以点明已经发生的关键因果、局势变化、伏笔性质或读者容易漏掉的信息；提示要帮助理解或建立期待，不能泄尽仍需保留的谜底，也不能替代后续可见的行动、得失与兑现。
...
2. 对照章纲和设定，列出本章必须推进、禁止提前揭露、禁止改写的内容；同时判断是否触发书内感情与成人内容专项约束，触发时按项目入口读取指定文件后再设计场景。
...
- 细节呈现与旁白点拨不是二选一。简单场景让动作和画面自行传意；复杂战局、多人博弈、密集线索或快速转场若只留静态画面会造成理解断层，可补一两句清楚、克制的全知提示。
- 审稿时不要只因“作者知道而人物不知道”删除旁白；应检查叙事视角是否稳定、信息是否允许向读者公开，以及该句是在降低理解成本、建立期待，还是在泄底、重复、说教。
...
36. 若本章触发书内感情与成人内容专项约束，是否已读取项目入口指定文件，并按该书规则核对人物边界、内容尺度、关系后果与呈现重点；是否误用本 Skill 的泛化描述覆盖项目规则或术语。
37. 复杂场景是否因过度依赖静态细节导致关键因果、局势变化或伏笔性质难以理解；全知提示是否克制、视角稳定、不泄底、不重复，并且没有替代实际冲突与爽点兑现。
