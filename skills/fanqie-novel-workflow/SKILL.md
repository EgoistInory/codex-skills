...
若目标书籍存在 `感情与成人内容规范.md`、亲密关系规范、双修规范或同类项目文件，不把它们设为所有章节的固定上下文；由当前章纲、近期正文、状态文件和审校目标判断是否触发。

以下内容触发后，必须在动笔、扩写、重写或审校前读取对应专项规范：

- 感情关系推进、暧昧试探、亲吻、同榻、双修或其他成年亲密场景。
- 婚契、炉鼎、采补、主奴禁制、胁迫关系、性权力压迫或反派私域迫害。
- 受害者处境、目击或延迟救援、事后创伤、关系后果及相关制度反击。

普通打斗、寻宝、修炼、赶路或制度推进章节若不涉及上述内容，无需重复加载专项规范。触发判断不能只依赖当前会话记忆；项目 `AGENTS.md`、`PROJECT_BRIEF.md`、`HANDOFF.md` 或其他恢复入口若列有条件必读文件，以项目入口为准。
...
2. 对照章纲和设定，列出本章必须推进、禁止提前揭露、禁止改写的内容；同时判断是否触发感情与成人内容专项规范，触发时先读取再设计场景。
...
36. 若本章触发感情与成人内容专项规范，是否已按项目文件核对人物成年与意愿、权力差和中止权、亲密关系的剧情后果，以及胁迫或侵害场景是否聚焦权力、反抗、证据、创伤和后果而非情色化过程。
